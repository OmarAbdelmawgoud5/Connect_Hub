...
public class Profile extends javax.swing.JFrame {
    ...
    public Profile(User user) {
       ...
       intialSetCover();
        ...
        imagelabel.setIcon(new ImageIcon(new ImageIcon(myUser.profilePhoto).getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH))); //Sets the image to be displayed as an icon
        fetchposts();
    ...
    void intialSetProfile()
    {
        ...
        label.setIcon(new ImageIcon(new ImageIcon(myUser.profilePhoto).getImage().getScaledInstance(50, 50, Image.SCALE_SMOOTH))); //Sets the image to be displayed as an icon
    ...
    private JPanel getpanel(Posts s,int i)
    {
        ...
        locallabel.setIcon(new ImageIcon(new ImageIcon(myUser.profilePhoto).getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH))); //Sets the image to be displayed as an icon
        locallabel.setBounds(-5,-10,30,40);
        panel.add(locallabel);
        int n=myUser.userName.length();
        var localname=new javax.swing.JTextArea();
        localname.setBounds(16,-3,7*n,17);
        localname.setEditable(false);
        localname.setText(myUser.userName);
        localname.setFont(new java.awt.Font("Segoe UI Variable", 0, 13));
        panel.add(localname);
        var localContent=new javax.swing.JTextArea();
        localContent.setBounds(240-4*s.Content.length(),25,9*s.Content.length(),20);
        localContent.setBackground(new java.awt.Color(165,210,207));

        System.out.println(s.Content.length());
        localContent.setEditable(false);
        localContent.setText(s.Content);
